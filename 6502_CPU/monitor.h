...
{
public:
	monitor(CPU_6502& cpuRef, deassembler deasmRef, std::string& deassemblyRef) : _cpu(cpuRef), _deasm(deasmRef), _deassembly(deassemblyRef)
	{
...
private:
	...
	{
		drawWindows();
		DrawString({ 48, 64 }, "Hello world!\nHello world!\n0123456789abcdef0123456789abcdef", olc::WHITE, 2);
		drawDeassembly();
		drawInternalStatus();
		drawPage();
	}
